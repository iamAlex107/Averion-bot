...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        if (!args[0]) {
            ...
            .addField(`📕 General:`, '`help`, `info`, `prefix`, `ping`, `uptime`, `link`')
            .addField(`🛠 Moderation`, '`ban`, `kick`, `mute`, `unmute`, `purge`')
            .addField(`🎨 Fun`, '`rps`, `coinflip`, `8ball`')
            .addField(`🖼 Images`, '`bobross`, `slap`, `triggered`, `wanted`')
            .addField(`🔨 Utility`, '`avatar`, `calculator`, `embed`, `enlarge`, `say`, `serverinfo`')
